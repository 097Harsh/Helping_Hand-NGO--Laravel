            ...
            <tbody>
              <tr>
                ...
                @if ($record->status == "Accepted")
                    <td><a href="{{ route('Recevied', $record->D_id) }}"><button class="btn btn-info">Recevied</button></a></td>
                @elseif ($record->status == "Recevied")
                    <td><a href="{{ route('Delivered', $record->D_id) }}"><button class="btn btn-success">Delivered</button></a></td>
                @else 
                    <td>Delivered</td>    
                @endif
