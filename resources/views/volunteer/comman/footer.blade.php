							...
							<div class="row sub-columns">
								<div class="col-lg-4 col-md-6 sub-one-left pr-lg-4">
									<h2><a class="navbar-brand" href="{{route('home')}}">
											<img src="user/assets/images/logo1.png" alt="Your logo" title="Your logo" style="height:60px;" />
								...
								<div class="col-lg-4 col-md-6 sub-one-left">
									...
									<div class="instagram-feeds">
										<div class="b-img"> <a href=""><img src="user/assets/images/f1.jpg"
													class="img-fluid" alt=""></a></div>
										<div class="b-img"> <a href=""><img src="user/assets/images/f2.jpg"
													class="img-fluid" alt=""></a></div>
										<div class="b-img"> <a href=""><img src="user/assets/images/f3.jpg"
													class="img-fluid" alt=""></a></div>
										<div class="b-img"> <a href=""><img src="user/assets/images/f4.jpg"
													class="img-fluid" alt=""></a></div>
										<div class="b-img"> <a href=""><img src="user/assets/images/f5.jpg"
													class="img-fluid" alt=""></a></div>
										<div class="b-img"> <a href=""><img src="user/assets/images/f6.jpg"
													class="img-fluid" alt=""></a></div>
									</div>
								</div>
							</div>
				...
				<div class="container">
					<div class="copyright-footer">
						<div class="columns text-lg-left">
							<p>© 2024 . All rights reserved | Designed by <a
