          ...
          <table class="table table-striped">
            <thead>
              <tr>
                ...
                @if(empty($m_donations))
                        <tbody>
                            <td>No record found</td>
                        </tbody>
                @elseif (!empty($m_donations))
                    @foreach($m_donations as $m_donation)
                        <tbody>
                            <td>{{$m_donation->m_id}}</td>
                            <td>{{$m_donation->msg}}</td>
                            <td>{{$m_donation->amt}}</td>
                            <td>{{$m_donation->d_date}}</td>
                        </tbody> 
                    @endforeach()
