        ...
        <div class="col-xl-4">
          ...
          <div class="card">
            <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
              ...
              <img src="{{ asset('storage/user/upload/' . $user->image) }}" alt="Profile" class="rounded-circle">
              <h2>{{$user->name}}</h2>
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8">{{$city->city_name}}</div>
                  </div>
                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Area</div>
                    <div class="col-lg-9 col-md-8">{{$area->area_name}}</div>
                  </div>
                  <div class="row">
